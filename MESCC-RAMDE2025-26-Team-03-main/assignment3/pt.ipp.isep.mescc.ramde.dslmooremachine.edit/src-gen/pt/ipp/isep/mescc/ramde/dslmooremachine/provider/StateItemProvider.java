...
/**
 * This is the item provider adapter for a {@link pt.ipp.isep.mescc.ramde.dslmooremachine.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						DslmooremachinePackage.Literals.STATE__NAME, true, false, false,
	...
	protected void addOutputPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						DslmooremachinePackage.Literals.STATE__OUTPUT, true, false, true, null, null, null));
	}
	...
	protected void addIncomingPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						DslmooremachinePackage.Literals.STATE__INCOMING, true, false, true, null, null, null));
	}
	...
	protected void addOutgoingPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						DslmooremachinePackage.Literals.STATE__OUTGOING, true, false, true, null, null, null));
	}

	/**
	 * This adds a property descriptor for the Initialnode feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addInitialnodePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_State_initialnode_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_State_initialnode_feature",
								"_UI_State_type"),
						DslmooremachinePackage.Literals.STATE__INITIALNODE, true, false, true, null, null, null));
	}
