...
/**
 * This is the item provider adapter for a {@link pt.ipp.isep.mescc.ramde.dslmooremachine.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						DslmooremachinePackage.Literals.EVENT__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Event_transition_feature",
								"_UI_Event_type"),
						DslmooremachinePackage.Literals.EVENT__TRANSITION, true, false, true, null, null, null));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		case DslmooremachinePackage.EVENT__NAME:
