...
/**
 * This is the item provider adapter for a {@link pt.ipp.isep.mescc.ramde.dslmealymachine.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransitionItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_name_feature",
								"_UI_Transition_type"),
						DslmealymachinePackage.Literals.TRANSITION__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_event_feature",
								"_UI_Transition_type"),
						DslmealymachinePackage.Literals.TRANSITION__EVENT, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_output_feature",
								"_UI_Transition_type"),
						DslmealymachinePackage.Literals.TRANSITION__OUTPUT, true, false, true, null, null, null));
	}
	...
	protected void addTargetStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Transition_targetState_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_targetState_feature",
								"_UI_Transition_type"),
						DslmealymachinePackage.Literals.TRANSITION__TARGET_STATE, true, false, true, null, null, null));
	}
	...
	protected void addSourceStatePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Transition_sourceState_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Transition_sourceState_feature",
								"_UI_Transition_type"),
						DslmealymachinePackage.Literals.TRANSITION__SOURCE_STATE, true, false, true, null, null, null));
	}
