 ...
 * @generated
 */
public class DslmooremachineSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case DslmooremachinePackage.MOORE_MACHINE: {
			MooreMachine mooreMachine = (MooreMachine) theEObject;
			T result = caseMooreMachine(mooreMachine);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Moore Machine</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Moore Machine</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMooreMachine(MooreMachine object) {
		return null;
	}
