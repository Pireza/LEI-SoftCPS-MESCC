...
import pt.ipp.isep.mescc.ramde.dslmooremachine.DslmooremachineFactory;
...
import pt.ipp.isep.mescc.ramde.dslmooremachine.util.DslmooremachineValidator;
 ...
 * @generated
 */
public class DslmooremachinePackageImpl extends EPackageImpl implements DslmooremachinePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private EClass mooreMachineEClass = null;
	 ...
	 * @see pt.ipp.isep.mescc.ramde.dslmooremachine.DslmooremachinePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private DslmooremachinePackageImpl() {
		super(eNS_URI, DslmooremachineFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link DslmooremachinePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static DslmooremachinePackage init() {
		if (isInited)
			return (DslmooremachinePackage) EPackage.Registry.INSTANCE.getEPackage(DslmooremachinePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredDslmooremachinePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		DslmooremachinePackageImpl theDslmooremachinePackage = registeredDslmooremachinePackage instanceof DslmooremachinePackageImpl
				? (DslmooremachinePackageImpl) registeredDslmooremachinePackage
				: new DslmooremachinePackageImpl();

		isInited = true;

		// Create package meta-data objects
		theDslmooremachinePackage.createPackageContents();

		// Initialize created meta-data
		theDslmooremachinePackage.initializePackageContents();

		// Register package validator
		EValidator.Registry.INSTANCE.put(theDslmooremachinePackage, new EValidator.Descriptor() {
			@Override
			public EValidator getEValidator() {
				return DslmooremachineValidator.INSTANCE;
			}
		});

		// Mark meta-data to indicate it can't be changed
		theDslmooremachinePackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(DslmooremachinePackage.eNS_URI, theDslmooremachinePackage);
		return theDslmooremachinePackage;
	}
	 ...
	 */
	@Override
	public EClass getMooreMachine() {
		return mooreMachineEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getMooreMachine_Name() {
		return (EAttribute) mooreMachineEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getMooreMachine_Initialnode() {
		return (EReference) mooreMachineEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 */
	@Override
	public EReference getMooreMachine_Event() {
		return (EReference) mooreMachineEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 */
	@Override
	public EReference getMooreMachine_Transition() {
		return (EReference) mooreMachineEClass.getEStructuralFeatures().get(3);
	}
	 ...
	 */
	@Override
	public EReference getMooreMachine_Output() {
		return (EReference) mooreMachineEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 */
	@Override
	public EReference getMooreMachine_State() {
		return (EReference) mooreMachineEClass.getEStructuralFeatures().get(5);
	}
	 ...
	 */
	@Override
	public EReference getOutput_State() {
	 ...
	 */
	@Override
	public DslmooremachineFactory getDslmooremachineFactory() {
		return (DslmooremachineFactory) getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		mooreMachineEClass = createEClass(MOORE_MACHINE);
		createEAttribute(mooreMachineEClass, MOORE_MACHINE__NAME);
		createEReference(mooreMachineEClass, MOORE_MACHINE__INITIALNODE);
		createEReference(mooreMachineEClass, MOORE_MACHINE__EVENT);
		createEReference(mooreMachineEClass, MOORE_MACHINE__TRANSITION);
		createEReference(mooreMachineEClass, MOORE_MACHINE__OUTPUT);
		createEReference(mooreMachineEClass, MOORE_MACHINE__STATE);
		...
		createEReference(outputEClass, OUTPUT__STATE);
	...
	public void initializePackageContents() {
		...
		initEClass(mooreMachineEClass, MooreMachine.class, "MooreMachine", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMooreMachine_Name(), ecorePackage.getEString(), "name", null, 0, 1, MooreMachine.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMooreMachine_Initialnode(), this.getInitialNode(), null, "initialnode", null, 1, 1,
				MooreMachine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMooreMachine_Event(), this.getEvent(), null, "event", null, 1, -1, MooreMachine.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMooreMachine_Transition(), this.getTransition(), null, "transition", null, 1, -1,
				MooreMachine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMooreMachine_Output(), this.getOutput(), null, "output", null, 1, -1, MooreMachine.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMooreMachine_State(), this.getState(), null, "state", null, 1, -1, MooreMachine.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getOutput_Name(), ecorePackage.getEString(), "name", null, 0, 1, Output.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getOutput_State(), this.getState(), this.getState_Output(), "state", null, 1, -1, Output.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getState_Name(), ecorePackage.getEString(), "name", null, 0, 1, State.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getState_Output(), this.getOutput(), this.getOutput_State(), "output", null, 1, 1, State.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createEcoreAnnotations() {
		...
		addAnnotation(this, source,
				new String[] { "invocationDelegates", "http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
						...
						"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot" });
		addAnnotation(mooreMachineEClass, source, new String[] { "constraints",
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation(mooreMachineEClass, source, new String[] { "onlyOneStateMachinePerDiagramIsAllowed",
				"MooreMachine.allInstances() -> size() = 1",
