 ...
 * </p>
 * <ul>
 *   <li>{@link pt.ipp.isep.mescc.ramde.dslmooremachine.Event#getName <em>Name</em>}</li>
 *   <li>{@link pt.ipp.isep.mescc.ramde.dslmooremachine.Event#getTransition <em>Transition</em>}</li>
 * </ul>
 *
 * @see pt.ipp.isep.mescc.ramde.dslmooremachine.DslmooremachinePackage#getEvent()
...
public interface Event extends EObject {
	 ...
	 * @see #setName(String)
	 * @see pt.ipp.isep.mescc.ramde.dslmooremachine.DslmooremachinePackage#getEvent_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link pt.ipp.isep.mescc.ramde.dslmooremachine.Event#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link pt.ipp.isep.mescc.ramde.dslmooremachine.Transition#getEvent <em>Event</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Transition</em>' reference list.
	 * @see pt.ipp.isep.mescc.ramde.dslmooremachine.DslmooremachinePackage#getEvent_Transition()
