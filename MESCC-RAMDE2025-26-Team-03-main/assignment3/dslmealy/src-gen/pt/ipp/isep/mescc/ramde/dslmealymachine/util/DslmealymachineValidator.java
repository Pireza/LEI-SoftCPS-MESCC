 ...
 * @generated
 */
public class DslmealymachineValidator extends EObjectValidator {
	/**
	 ...
	 * @generated
	 */
	public static final DslmealymachineValidator INSTANCE = new DslmealymachineValidator();
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "pt.ipp.isep.mescc.ramde.dslmealymachine";
	 ...
	 * @generated
	 */
	public DslmealymachineValidator() {
		super();
	}
	...
	protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics,
		...
		case DslmealymachinePackage.MEALY_MACHINE:
			return validateMealyMachine((MealyMachine) value, diagnostics, context);
	 ...
	 * @generated
	 */
	public boolean validateMealyMachine(MealyMachine mealyMachine, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		if (!validate_NoCircularContainment(mealyMachine, diagnostics, context))
			return false;
		boolean result = validate_EveryMultiplicityConforms(mealyMachine, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryDataValueConforms(mealyMachine, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryReferenceIsContained(mealyMachine, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryBidirectionalReferenceIsPaired(mealyMachine, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryProxyResolves(mealyMachine, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_UniqueID(mealyMachine, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryKeyUnique(mealyMachine, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryMapEntryUnique(mealyMachine, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateMealyMachine_onlyOneStateMachinePerDiagramIsAllowed(mealyMachine, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateMealyMachine_machineNameMustHaveAtLeastThreeCharactersExcludingRepeatingEmptySpaces(
					mealyMachine, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateMealyMachine_machineNameMustStartWithUppercase(mealyMachine, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateMealyMachine_statesNamesShouldBeUnique(mealyMachine, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateMealyMachine_transitionsNamesShouldBeUnique(mealyMachine, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateMealyMachine_outputNamesShouldBeUnique(mealyMachine, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateMealyMachine_eventNamesShouldBeUnique(mealyMachine, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateMealyMachine_nameMustHaveThirtyCharactersAtMax(mealyMachine, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateMealyMachine_nameShouldNotContainSpecialCharacters(mealyMachine, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateMealyMachine_nameShouldNotContainNumbers(mealyMachine, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateMealyMachine_twoTransitionsShouldNotTakeTheSameSourceAndEvent(mealyMachine, diagnostics,
					context);
		return result;
	}

	/**
	 * The cached validation expression for the onlyOneStateMachinePerDiagramIsAllowed constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String MEALY_MACHINE__ONLY_ONE_STATE_MACHINE_PER_DIAGRAM_IS_ALLOWED__EEXPRESSION = "MealyMachine.allInstances() -> size() = 1";

	/**
	 * Validates the onlyOneStateMachinePerDiagramIsAllowed constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateMealyMachine_onlyOneStateMachinePerDiagramIsAllowed(MealyMachine mealyMachine,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate(DslmealymachinePackage.Literals.MEALY_MACHINE, mealyMachine, diagnostics, context,
				"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot", "onlyOneStateMachinePerDiagramIsAllowed",
				MEALY_MACHINE__ONLY_ONE_STATE_MACHINE_PER_DIAGRAM_IS_ALLOWED__EEXPRESSION, Diagnostic.ERROR,
				DIAGNOSTIC_SOURCE, 0);
	}

	/**
	 * The cached validation expression for the machineNameMustHaveAtLeastThreeCharactersExcludingRepeatingEmptySpaces constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String MEALY_MACHINE__MACHINE_NAME_MUST_HAVE_AT_LEAST_THREE_CHARACTERS_EXCLUDING_REPEATING_EMPTY_SPACES__EEXPRESSION = "self.name.trim().size() >= 3";

	/**
	 * Validates the machineNameMustHaveAtLeastThreeCharactersExcludingRepeatingEmptySpaces constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateMealyMachine_machineNameMustHaveAtLeastThreeCharactersExcludingRepeatingEmptySpaces(
			MealyMachine mealyMachine, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate(DslmealymachinePackage.Literals.MEALY_MACHINE, mealyMachine, diagnostics, context,
				"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
				"machineNameMustHaveAtLeastThreeCharactersExcludingRepeatingEmptySpaces",
				MEALY_MACHINE__MACHINE_NAME_MUST_HAVE_AT_LEAST_THREE_CHARACTERS_EXCLUDING_REPEATING_EMPTY_SPACES__EEXPRESSION,
				Diagnostic.ERROR, DIAGNOSTIC_SOURCE, 0);
	}

	/**
	 * The cached validation expression for the machineNameMustStartWithUppercase constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String MEALY_MACHINE__MACHINE_NAME_MUST_START_WITH_UPPERCASE__EEXPRESSION = "self.name.trim().substring(1, 1).toUpper().compareTo(self.name.trim().substring(1, 1)) = 0";

	/**
	 * Validates the machineNameMustStartWithUppercase constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateMealyMachine_machineNameMustStartWithUppercase(MealyMachine mealyMachine,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate(DslmealymachinePackage.Literals.MEALY_MACHINE, mealyMachine, diagnostics, context,
				"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot", "machineNameMustStartWithUppercase",
				MEALY_MACHINE__MACHINE_NAME_MUST_START_WITH_UPPERCASE__EEXPRESSION, Diagnostic.ERROR, DIAGNOSTIC_SOURCE,
				0);
	}

	/**
	 * The cached validation expression for the statesNamesShouldBeUnique constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String MEALY_MACHINE__STATES_NAMES_SHOULD_BE_UNIQUE__EEXPRESSION = "self.state -> forAll(s1, s2 | s1 <> s2 implies s1.name.trim().equalsIgnoreCase(s2.name.trim()) = false)";

	/**
	 * Validates the statesNamesShouldBeUnique constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateMealyMachine_statesNamesShouldBeUnique(MealyMachine mealyMachine,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate(DslmealymachinePackage.Literals.MEALY_MACHINE, mealyMachine, diagnostics, context,
				"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot", "statesNamesShouldBeUnique",
				MEALY_MACHINE__STATES_NAMES_SHOULD_BE_UNIQUE__EEXPRESSION, Diagnostic.ERROR, DIAGNOSTIC_SOURCE, 0);
	}

	/**
	 * The cached validation expression for the transitionsNamesShouldBeUnique constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String MEALY_MACHINE__TRANSITIONS_NAMES_SHOULD_BE_UNIQUE__EEXPRESSION = "self.transition -> forAll(t1, t2 | t1 <> t2 implies t1.name.trim().equalsIgnoreCase(t2.name.trim()) = false)";

	/**
	 * Validates the transitionsNamesShouldBeUnique constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateMealyMachine_transitionsNamesShouldBeUnique(MealyMachine mealyMachine,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate(DslmealymachinePackage.Literals.MEALY_MACHINE, mealyMachine, diagnostics, context,
				"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot", "transitionsNamesShouldBeUnique",
				MEALY_MACHINE__TRANSITIONS_NAMES_SHOULD_BE_UNIQUE__EEXPRESSION, Diagnostic.ERROR, DIAGNOSTIC_SOURCE, 0);
	}

	/**
	 * The cached validation expression for the outputNamesShouldBeUnique constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String MEALY_MACHINE__OUTPUT_NAMES_SHOULD_BE_UNIQUE__EEXPRESSION = "self.output -> forAll(o1, o2 | o1 <> o2 implies o1.name.trim().equalsIgnoreCase(o2.name.trim()) = false)";

	/**
	 * Validates the outputNamesShouldBeUnique constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateMealyMachine_outputNamesShouldBeUnique(MealyMachine mealyMachine,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate(DslmealymachinePackage.Literals.MEALY_MACHINE, mealyMachine, diagnostics, context,
				"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot", "outputNamesShouldBeUnique",
				MEALY_MACHINE__OUTPUT_NAMES_SHOULD_BE_UNIQUE__EEXPRESSION, Diagnostic.ERROR, DIAGNOSTIC_SOURCE, 0);
	}

	/**
	 * The cached validation expression for the eventNamesShouldBeUnique constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String MEALY_MACHINE__EVENT_NAMES_SHOULD_BE_UNIQUE__EEXPRESSION = "self.event -> forAll(e1, e2 | e1 <> e2 implies e1.name.trim().equalsIgnoreCase(e2.name.trim()) = false)";

	/**
	 * Validates the eventNamesShouldBeUnique constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateMealyMachine_eventNamesShouldBeUnique(MealyMachine mealyMachine, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		return validate(DslmealymachinePackage.Literals.MEALY_MACHINE, mealyMachine, diagnostics, context,
				"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot", "eventNamesShouldBeUnique",
				MEALY_MACHINE__EVENT_NAMES_SHOULD_BE_UNIQUE__EEXPRESSION, Diagnostic.ERROR, DIAGNOSTIC_SOURCE, 0);
	}

	/**
	 * The cached validation expression for the nameMustHaveThirtyCharactersAtMax constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String MEALY_MACHINE__NAME_MUST_HAVE_THIRTY_CHARACTERS_AT_MAX__EEXPRESSION = "self.name.trim().size() <= 30";

	/**
	 * Validates the nameMustHaveThirtyCharactersAtMax constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateMealyMachine_nameMustHaveThirtyCharactersAtMax(MealyMachine mealyMachine,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate(DslmealymachinePackage.Literals.MEALY_MACHINE, mealyMachine, diagnostics, context,
				"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot", "nameMustHaveThirtyCharactersAtMax",
				MEALY_MACHINE__NAME_MUST_HAVE_THIRTY_CHARACTERS_AT_MAX__EEXPRESSION, Diagnostic.ERROR,
				DIAGNOSTIC_SOURCE, 0);
	}

	/**
	 * The cached validation expression for the nameShouldNotContainSpecialCharacters constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String MEALY_MACHINE__NAME_SHOULD_NOT_CONTAIN_SPECIAL_CHARACTERS__EEXPRESSION = "self.name.characters()->forAll(c | '\\\\|!\"@#£$§%&/{[]=}?\\'»«+*¨`´~^.:,;'.indexOf(c) = 0)";

	/**
	 * Validates the nameShouldNotContainSpecialCharacters constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateMealyMachine_nameShouldNotContainSpecialCharacters(MealyMachine mealyMachine,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate(DslmealymachinePackage.Literals.MEALY_MACHINE, mealyMachine, diagnostics, context,
				"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot", "nameShouldNotContainSpecialCharacters",
				MEALY_MACHINE__NAME_SHOULD_NOT_CONTAIN_SPECIAL_CHARACTERS__EEXPRESSION, Diagnostic.ERROR,
				DIAGNOSTIC_SOURCE, 0);
	}

	/**
	 * The cached validation expression for the nameShouldNotContainNumbers constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String MEALY_MACHINE__NAME_SHOULD_NOT_CONTAIN_NUMBERS__EEXPRESSION = "self.name.characters()->forAll(c | '0123456789'.indexOf(c) = 0)";

	/**
	 * Validates the nameShouldNotContainNumbers constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateMealyMachine_nameShouldNotContainNumbers(MealyMachine mealyMachine,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate(DslmealymachinePackage.Literals.MEALY_MACHINE, mealyMachine, diagnostics, context,
				"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot", "nameShouldNotContainNumbers",
				MEALY_MACHINE__NAME_SHOULD_NOT_CONTAIN_NUMBERS__EEXPRESSION, Diagnostic.ERROR, DIAGNOSTIC_SOURCE, 0);
	}

	/**
	 * The cached validation expression for the twoTransitionsShouldNotTakeTheSameSourceAndEvent constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected static final String MEALY_MACHINE__TWO_TRANSITIONS_SHOULD_NOT_TAKE_THE_SAME_SOURCE_AND_EVENT__EEXPRESSION = "self.transition -> forAll(t1, t2 | (t1 <> t2 and t1.event = t2.event implies t1.sourceState <> t2.sourceState) or (t1 <> t2 and t1.sourceState = t2.sourceState implies t1.event <> t2.event))";

	/**
	 * Validates the twoTransitionsShouldNotTakeTheSameSourceAndEvent constraint of '<em>Mealy Machine</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateMealyMachine_twoTransitionsShouldNotTakeTheSameSourceAndEvent(MealyMachine mealyMachine,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate(DslmealymachinePackage.Literals.MEALY_MACHINE, mealyMachine, diagnostics, context,
				"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot", "twoTransitionsShouldNotTakeTheSameSourceAndEvent",
				MEALY_MACHINE__TWO_TRANSITIONS_SHOULD_NOT_TAKE_THE_SAME_SOURCE_AND_EVENT__EEXPRESSION, Diagnostic.ERROR,
				DIAGNOSTIC_SOURCE, 0);
	}
	...
	public boolean validateState_stateNameMustHaveAtLeastThreeCharactersExcludingRepeatingEmptySpaces(State state,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate(DslmealymachinePackage.Literals.STATE, state, diagnostics, context,
				"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
	...
	public boolean validateOutput_outputNameMustHaveAtLeastThreeCharactersExcludingRepeatingEmptySpaces(Output output,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate(DslmealymachinePackage.Literals.OUTPUT, output, diagnostics, context,
				"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
	...
	public boolean validateEvent_eventNameMustHaveAtLeastThreeCharactersExcludingRepeatingEmptySpaces(Event event,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate(DslmealymachinePackage.Literals.EVENT, event, diagnostics, context,
				"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
	...
	public boolean validateTransition_transitionNameMustHaveAtLeastThreeCharactersExcludingRepeatingEmptySpaces(
		...
		return validate(DslmealymachinePackage.Literals.TRANSITION, transition, diagnostics, context,
				"http://www.eclipse.org/emf/2002/Ecore/OCL/Pivot",
