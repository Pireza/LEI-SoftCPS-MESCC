 ...
 * </p>
 * <ul>
 *   <li>{@link pt.ipp.isep.mescc.ramde.dslmealymachine.MealyMachine#getName <em>Name</em>}</li>
 *   <li>{@link pt.ipp.isep.mescc.ramde.dslmealymachine.MealyMachine#getEvent <em>Event</em>}</li>
 *   <li>{@link pt.ipp.isep.mescc.ramde.dslmealymachine.MealyMachine#getTransition <em>Transition</em>}</li>
 *   <li>{@link pt.ipp.isep.mescc.ramde.dslmealymachine.MealyMachine#getInitialnode <em>Initialnode</em>}</li>
 *   <li>{@link pt.ipp.isep.mescc.ramde.dslmealymachine.MealyMachine#getState <em>State</em>}</li>
 *   <li>{@link pt.ipp.isep.mescc.ramde.dslmealymachine.MealyMachine#getOutput <em>Output</em>}</li>
 * </ul>
 *
 * @see pt.ipp.isep.mescc.ramde.dslmealymachine.DslmealymachinePackage#getMealyMachine()
...
public interface MealyMachine extends EObject {
	 ...
	 * @see #setName(String)
	 * @see pt.ipp.isep.mescc.ramde.dslmealymachine.DslmealymachinePackage#getMealyMachine_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link pt.ipp.isep.mescc.ramde.dslmealymachine.MealyMachine#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link pt.ipp.isep.mescc.ramde.dslmealymachine.Event}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Event</em>' containment reference list.
	 * @see pt.ipp.isep.mescc.ramde.dslmealymachine.DslmealymachinePackage#getMealyMachine_Event()
	 ...
	 * @see pt.ipp.isep.mescc.ramde.dslmealymachine.DslmealymachinePackage#getMealyMachine_Transition()
	 * @model containment="true" required="true"
	 * @generated
	 */
	 ...
	 * @see pt.ipp.isep.mescc.ramde.dslmealymachine.DslmealymachinePackage#getMealyMachine_Initialnode()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link pt.ipp.isep.mescc.ramde.dslmealymachine.MealyMachine#getInitialnode <em>Initialnode</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link pt.ipp.isep.mescc.ramde.dslmealymachine.State}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>State</em>' containment reference list.
	 * @see pt.ipp.isep.mescc.ramde.dslmealymachine.DslmealymachinePackage#getMealyMachine_State()
	 ...
	 * The list contents are of type {@link pt.ipp.isep.mescc.ramde.dslmealymachine.Output}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Output</em>' containment reference list.
	 * @see pt.ipp.isep.mescc.ramde.dslmealymachine.DslmealymachinePackage#getMealyMachine_Output()
	 * @model containment="true" required="true"
	 * @generated
	 */
