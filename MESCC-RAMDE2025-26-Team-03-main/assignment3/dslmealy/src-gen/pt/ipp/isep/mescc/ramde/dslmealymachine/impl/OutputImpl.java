 ...
 * </p>
 * <ul>
 *   <li>{@link pt.ipp.isep.mescc.ramde.dslmealymachine.impl.OutputImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.ipp.isep.mescc.ramde.dslmealymachine.impl.OutputImpl#getTransition <em>Transition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutputImpl extends MinimalEObjectImpl.Container implements Output {
	...
	protected EClass eStaticClass() {
		return DslmealymachinePackage.Literals.OUTPUT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DslmealymachinePackage.OUTPUT__NAME, oldName, name));
	}
	...
	public EList<Transition> getTransition() {
		if (transition == null) {
			transition = new EObjectWithInverseResolvingEList<Transition>(Transition.class, this,
					DslmealymachinePackage.OUTPUT__TRANSITION, DslmealymachinePackage.TRANSITION__OUTPUT);
		}
		return transition;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case DslmealymachinePackage.OUTPUT__TRANSITION:
