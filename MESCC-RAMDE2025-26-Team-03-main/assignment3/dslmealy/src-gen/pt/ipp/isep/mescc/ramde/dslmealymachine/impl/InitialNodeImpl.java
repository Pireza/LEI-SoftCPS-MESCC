 ...
 * </p>
 * <ul>
 *   <li>{@link pt.ipp.isep.mescc.ramde.dslmealymachine.impl.InitialNodeImpl#getInitialState <em>Initial State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InitialNodeImpl extends MinimalEObjectImpl.Container implements InitialNode {
	...
	protected EClass eStaticClass() {
		return DslmealymachinePackage.Literals.INITIAL_NODE;
	}
			...
			if (initialState != oldInitialState) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DslmealymachinePackage.INITIAL_NODE__INITIAL_STATE, oldInitialState, initialState));
			}
		}
		return initialState;
	}
	...
	public NotificationChain basicSetInitialState(State newInitialState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					DslmealymachinePackage.INITIAL_NODE__INITIAL_STATE, oldInitialState, newInitialState);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setInitialState(State newInitialState) {
		if (newInitialState != initialState) {
			...
			if (initialState != null)
				msgs = ((InternalEObject) initialState).eInverseRemove(this, DslmealymachinePackage.STATE__INITIALNODE,
						State.class, msgs);
			if (newInitialState != null)
				msgs = ((InternalEObject) newInitialState).eInverseAdd(this, DslmealymachinePackage.STATE__INITIALNODE,
						State.class, msgs);
			msgs = basicSetInitialState(newInitialState, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DslmealymachinePackage.INITIAL_NODE__INITIAL_STATE,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case DslmealymachinePackage.INITIAL_NODE__INITIAL_STATE:
			if (initialState != null)
				msgs = ((InternalEObject) initialState).eInverseRemove(this, DslmealymachinePackage.STATE__INITIALNODE,
						State.class, msgs);
