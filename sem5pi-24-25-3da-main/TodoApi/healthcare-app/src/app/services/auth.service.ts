...
export class AuthService {
  ...
  public getAllAppointmentsUrl = 'http://localhost:3000/api/getAllApointments';
  public updateSurgeryAppointmentUrl = 'http://localhost:3000/api/updateAppointment';
  public getRoomsUrl = 'http://localhost:3000/api/getAllRooms';
  ...
  createRoom(
    ...
    // Perform the POST request to create a new room
  ...
  getAllAppointments(): Observable<any> {
    const headers = new HttpHeaders({
      Authorization: `Bearer ${this.accessToken}`, // Include the access token
    });
  
    return this.http.get<any>(this.getAllAppointmentsUrl, { headers });
  }
  ...
  updateAppointment(
    ...
    return this.http.put(`${this.updateSurgeryAppointmentUrl}/${appointmentId}`, updatedData, { headers });
  }
...
getRooms(): Observable<any> {
  return this.http.get<any>(this.getRoomsUrl);
}
