...
import { CreateTypeRoomComponent } from './components/create-type-room/create-type-room.component';
...
import { UpdateSurgeryAppointmentComponent } from './components/update-surgery-appointment/update-surgery-appointment.component';
...
export const routes: Routes = [
  ...
  { path: 'create-type-room', component: CreateTypeRoomComponent },
  ...
  { path: 'update-surgery-appointment', component: UpdateSurgeryAppointmentComponent },
