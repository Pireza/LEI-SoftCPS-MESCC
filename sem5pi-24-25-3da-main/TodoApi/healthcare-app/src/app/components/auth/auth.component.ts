...
import { CreateTypeRoomComponent } from '../create-type-room/create-type-room.component';
...
import { UpdateSurgeryAppointmentComponent } from '../update-surgery-appointment/update-surgery-appointment.component';
...
@Component({
  ...
  standalone: true,
  imports: [ResetPasswordComponent, CommonModule, AddOperationTypeComponent, FilterRequestsComponent, CreateStaffAdminComponent, CreatePatientAdminComponent, EditPatientProfileAdminComponent, DeletePatientProfileAdminComponent, EditStaffAdminComponent, DeactivateStaffProfileAdminComponent, SearchStaffProfileAdminComponent, CreateOperationDoctorComponent, UpdateOperationTypeComponent, CreateTypeRoomComponent, GetAllRoomsComponent, UpdateMedicalRecordComponent, AppointmentsComponent, ManagePatientProfileComponent, SearchRecordsComponent]
})
export class AuthComponent {
  ...
  handleClick(action: string) {
    ...
    } else if (action === 'Update a surgery appointment') {
      this.activeComponent = UpdateSurgeryAppointmentComponent;
    } else if (action === 'Add Room') {
      this.activeComponent = CreateTypeRoomComponent;
  ...
  getSubmenuItems(menuItem: string) {
    if (menuItem === 'Manage Patients') {
      ...
      return ['Search Allergies', 'Search Medical Conditions', 'Update Medical Record', 'Search Medical Records', 'Create a surgery appointment', 'Update a surgery appointment'];
    }
    return [];
  }
